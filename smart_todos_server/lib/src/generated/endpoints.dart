...
import 'package:smart_todos_server/src/generated/todos.dart' as _i6;
        ...
        'createTodo': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['todo'] as _i4.TodoEndpoint).createTodo(
                session,
                params['title'],
                params['description'],
              ),
        ...
        'updateTodo': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['todo'] as _i4.TodoEndpoint).updateTodo(
                session,
                params['todo'],
              ),
        ),
        'deleteTodo': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['todo'] as _i4.TodoEndpoint).deleteTodo(
                session,
                params['id'],
              ),
        ),
